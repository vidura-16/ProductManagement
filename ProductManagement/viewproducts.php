...
<div class="col-md-3">
            ...
            <img src="images\<?= $row['image']?>" class="image-fluid" style="height: 200px width:  200px;" >
                  </a>
                </div>
                ...
                <ul class="icons">
                 ...
                 <button type="submit" name="deletebtn" ><i class="bx bx-trash" aria-hidden="true" onclick="myFunction()"></i> </button>
                                        </form>
                                        <script>
                                    function myFunction() {
                                        alert("ITEM DELETED");
