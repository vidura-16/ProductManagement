...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=434207965ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=product&table=addproduct">`product`.`addproduct`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=riddlegames&table=user">`riddlegames`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=product&table=sample_data">`product`.`sample_data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=healthff&table=diabetics">`healthff`.`diabetics`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=healthff&table=thalasemia">`healthff`.`thalasemia`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=healthff&table=heart+disease">`healthff`.`heart disease`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=healthff&table=patient">`healthff`.`patient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=healthff&table=user">`healthff`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="626b4f51333549277b2d3e63333d7a44">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="riddlegames" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="product" targettable="addproduct">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addproduct`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="product" targettable="addproduct">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `addproduct` WHERE `addproduct`.`id` = 11</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="product" targettable="addproduct">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `addproduct` WHERE `addproduct`.`id` = 23</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="product" targettable="addproduct">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addproduct`  
ORDER BY `addproduct`.`id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="product" targettable="addproduct">
                            <div class="action_content">
